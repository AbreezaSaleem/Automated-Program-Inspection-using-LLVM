...
@.str = private unnamed_addr constant [21 x i8] c"i am solutions meh!\0A\00", align 1
@.str1 = private unnamed_addr constant [14 x i8] c"[wer\0Atee\0Atjh]\00", align 1
@.str2 = private unnamed_addr constant [12 x i8] c"Calling 1!\0A\00", align 1
@.str3 = private unnamed_addr constant [12 x i8] c"Calling 2!\0A\00", align 1
@.str4 = private unnamed_addr constant [12 x i8] c"Calling 3!\0A\00", align 1
@.str5 = private unnamed_addr constant [12 x i8] c"Calling 4!\0A\00", align 1
@.str6 = private unnamed_addr constant [13 x i8] c"mmm axcuseh\0A\00", align 1
@.str7 = private unnamed_addr constant [17 x i8] c"outputss/fml.txt\00", align 1
@.str8 = private unnamed_addr constant [6 x i8] c"done\0A\00", align 1
@.str9 = private unnamed_addr constant [8 x i8] c"1 done\0A\00", align 1
...
define float @_Z3mehf(float %a) #3 {
entry:
  %a.addr = alloca float, align 4
  store float %a, float* %a.addr, align 4
  %call = call %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* @_ZSt4cout, i8* getelementptr inbounds ([21 x i8]* @.str, i32 0, i32 0))
...
entry:
  ...
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC1EPKcRKS3_(%"class.std::__cxx11::basic_string"* %agg.result, i8* getelementptr inbounds ([14 x i8]* @.str1, i32 0, i32 0), %"class.std::allocator"* %ref.tmp)
...
declare %"class.std::basic_ostream"* @_ZStlsIcSt11char_traitsIcESaIcEERSt13basic_ostreamIT_T0_ES7_RKNSt7__cxx1112basic_stringIS4_S5_T1_EE(%"class.std::basic_ostream"*, %"class.std::__cxx11::basic_string"*) #0
...
entry:
  ...
  %call = call %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* @_ZSt4cout, i8* getelementptr inbounds ([12 x i8]* @.str5, i32 0, i32 0))
  %0 = load %"class.std::basic_ofstream"** %outfile.addr, align 8
  %1 = bitcast %"class.std::basic_ofstream"* %0 to %"class.std::basic_ostream"*
  %call1 = call float @_Z3mehf(float 3.550000e+01)
  %call2 = call %"class.std::basic_ostream"* @_ZNSolsEf(%"class.std::basic_ostream"* %1, float %call1)
  %2 = load %"class.std::basic_ofstream"** %outfile.addr, align 8
  %3 = bitcast %"class.std::basic_ofstream"* %2 to %"class.std::basic_ostream"*
  %call3 = call %"class.std::basic_ostream"* @_ZNSolsEPFRSoS_E(%"class.std::basic_ostream"* %3, %"class.std::basic_ostream"* (%"class.std::basic_ostream"*)* @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  ret void
}
...
; Function Attrs: nounwind uwtable
define void @_Z7uselessRSt14basic_ofstreamIcSt11char_traitsIcEE(%"class.std::basic_ofstream"* %outfile) #2 {
entry:
  %outfile.addr = alloca %"class.std::basic_ofstream"*, align 8
  store %"class.std::basic_ofstream"* %outfile, %"class.std::basic_ofstream"** %outfile.addr, align 8
  ret void
...
entry:
  ...
  %call = call %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* @_ZSt4cout, i8* getelementptr inbounds ([13 x i8]* @.str6, i32 0, i32 0))
  call void @_ZNSt14basic_ofstreamIcSt11char_traitsIcEEC1Ev(%"class.std::basic_ofstream"* %outfile)
  invoke void @_ZNSt14basic_ofstreamIcSt11char_traitsIcEE4openEPKcSt13_Ios_Openmode(%"class.std::basic_ofstream"* %outfile, i8* getelementptr inbounds ([17 x i8]* @.str7, i32 0, i32 0), i32 1)
          to label %invoke.cont unwind label %lpad

invoke.cont:                                      ; preds = %entry
  %call2 = invoke %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* @_ZSt4cout, i8* getelementptr inbounds ([6 x i8]* @.str8, i32 0, i32 0))
...
invoke.cont3:                                     ; preds = %invoke.cont1
  %call5 = invoke %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* @_ZSt4cout, i8* getelementptr inbounds ([8 x i8]* @.str9, i32 0, i32 0))
