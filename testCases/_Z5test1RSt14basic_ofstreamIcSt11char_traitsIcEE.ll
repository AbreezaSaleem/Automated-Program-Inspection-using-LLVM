; ModuleID = '/home/abreeza/Desktop/cse231-proj1/scriptss/../testCases/_Z5test1RSt14basic_ofstreamIcSt11char_traitsIcEE.bc'
...
; Function Attrs: uwtable
define void @_Z5test1RSt14basic_ofstreamIcSt11char_traitsIcEE(%"class.std::basic_ofstream"* %outfile) #2 {
entry:
  ...
  call void @_Z13insertionSortPii(i32* getelementptr inbounds ([5 x i32]* @arr, i32 0, i32 0), i32 %0)
  %call = call %"class.std::basic_ostream"* @_ZNSolsEPFRSoS_E(%"class.std::basic_ostream"* @_ZSt4cout, %"class.std::basic_ostream"* (%"class.std::basic_ostream"*)* @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  ret void
}
